module "cluster-1" {
  ...
  node_pool_size = var.node_pool_size_Cluster1
  instance_os = var.instance_os
  linux_os_version = var.linux_os_version
  Shape = var.Shape_1
  Flex_shape_memory = var.Flex_shape_memory_Cluster1
  Flex_shape_ocpus = var.Flex_shape_ocpus_Cluster1
...
module "cluster-3" {
  ...
  { Shape_3 = var.Shape_3_pool2 
    size = var.node_pool2_size_Cluster3
    name = "pool2"
  }
  ]
